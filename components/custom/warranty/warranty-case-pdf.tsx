...
export function WarrantyCasePDF({
  case_,
  companyAddress = "To be configured in settings",
  officeNumber = "To be configured in settings",
  whatsappNumber = "To be configured in settings",
  footerNotes = "To be configured in settings",
}: WarrantyCasePDFProps) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            <View style={{ ...styles.logoSection }}>
              <Svg width="60" height="60" viewBox="0 0 771.54 771.57">
                <Path
          ...
          {/* Title Section */}
          <Text style={styles.title}>Warranty Service Receipt</Text>
          <Text style={styles.subtitle}>
            Service No: {case_.serviceNo} | Generated on{" "}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{case_.serviceNo}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Customer Name:</Text>
            <Text style={styles.value}>{case_.customerName || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Customer Contact:</Text>
            <Text style={styles.value}>{case_.customerContact || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Customer Email:</Text>
            <Text style={styles.value}>{case_.customerEmail || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Address:</Text>
            <Text style={styles.value}>{case_.address || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{formatDate(case_.purchaseDate)}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Invoice:</Text>
            <Text style={styles.value}>{case_.invoice || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{case_.status.replace("_", " ")}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Received By:</Text>
            <Text style={styles.value}>{case_.receivedBy?.name || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Serviced By:</Text>
            <Text style={styles.value}>{case_.servicedBy?.name || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Received On:</Text>
            <Text style={styles.value}>{formatDate(case_.createdAt)}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Received Items:</Text>
            <Text style={styles.value}>{case_.receivedItems || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Cost:</Text>
            <Text style={styles.value}>
              RM {case_.cost?.toFixed(2) || "0.00"}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>{case_.issues || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Solutions:</Text>
            <Text style={styles.value}>{case_.solutions || "N/A"}</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Remarks:</Text>
            <Text style={styles.value}>{case_.remarks || "N/A"}</Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.footerBottom}>
            <Text>Branch: {case_.branch?.name || "N/A"}</Text>
            <Text>
